...
class SceneWithUIBackground(Scene):
    """
    Сцена з фоном з config/ui.py → SCENE_BACKGROUNDS.
    Якщо фон не вказано — малює COLOR_BG.

    Використання:
        class MyScene(SceneWithUIBackground):
            def __init__(self, game):
                super().__init__(game, "village")   # ключ з SCENE_BACKGROUNDS
    """

    def __init__(self, game: 'Game', scene_key: str):
        super().__init__(game)
